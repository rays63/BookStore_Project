...
<body>
        ...
        <div class="container-fluid" id="header">
            <div class="row">
                <div class="col-md-3 col-lg-3" id="category">
                    <div style="background:#67d6cc;color:#fff;font-weight:800;border:none;padding:15px;"> The Book Shop
                    </div>
                    <ul>
    ...
    <div class="container-fluid text-center" id="new">
        <div class="row">
            <div class="col-sm-6 col-md-3 col-lg-3">
                <a href="description.php?ID=LIT-33">
                    <div class="book-block">
                        <div class="tag">Literature & Fiction</div>
                        <div class="tag-side"><img src="img/tag.png"></div>
                        <img class="book block-center img-responsive" src="img/books/LIT-33.jpg"
                            style="height: 299.17px; width:299.17px">
                        <hr>
                        Harry Potter And The Goblet Of Fire<br>
                        Rs 310 &nbsp
                        <span style="text-decoration:line-through;color:#828282;"> 510 </span>
                        <span class="label label-warning">27%</span>
                    </div>
                </a>
            </div>
            <div class="col-sm-6 col-md-3 col-lg-3">
                <a href="description.php?ID=HEA-2">
                    <div class="book-block">
                        <div class="tag">Health and Cooking</div>
                        <div class="tag-side"><img src="img/tag.png"></div>
                        <img class="book block-center img-responsive" src="img/books/HEA-2.jpg"
                            style="height: 299.17px; width:299.17px">
                        <hr>
                        Cake & Bakes<br>
                        Rs 280 &nbsp
                        <span style="text-decoration:line-through;color:#828282;"> 350 </span>
                        <span class="label label-warning">20%</span>
                    </div>
                </a>
            </div>
            <div class="col-sm-6 col-md-3 col-lg-3">
                <a href="description.php?ID=BUS-12">
                    <div class="book-block">
                        <div class="tag">Business and Management</div>
                        <div class="tag-side"><img src="img/tag.png"></div>
                        <img class="book block-center img-responsive" src="img/books/BUS-12.jpg"
                            style="height: 299.17px; width:299.17px">
                        <hr>
                        Human Resource Management : Text and Cases 7th Edition<br>
                        Rs 443 &nbsp
                        <span style="text-decoration:line-through;color:#828282;"> 525 </span>
            ...
            <div class="col-sm-6 col-md-3 col-lg-3">
                <a href="description.php?ID=CHILD-6">
                    <div class="book-block">
                        <div class="tag">Children and Teens</div>
                        <div class="tag-side"><img src="img/tag.png"></div>
                        <img class="book block-center img-responsive" src="img/books/CHILD-6.jpg"
                            style="height: 299.17px; width:299.17px">
                        <hr>
                        Human Resource Management : Text and Cases 7th Edition<br>
                        Rs 194 &nbsp
                        <span style="text-decoration:line-through;color:#828282;"> 299 </span>
    ...
    <div class="container-fluid" id="author">
        <h3 style="color:#67d6cc;"> POPULAR AUTHORS </h3>
        <div class="row">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-7 col-md-5 col-lg-5"
                    style="align-items: center;justify-content: center;margin: auto;display: contents;">
